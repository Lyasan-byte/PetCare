...
final class PublicPetsView: UIView {
    ...
    func registerCells() {
        collection.register(
            PublicPetsHeaderCollectionViewCell.self,
            forCellWithReuseIdentifier: PublicPetsHeaderCollectionViewCell.identifier
        )
        collection.register(
            PublicPetCollectionViewCell.self,
            forCellWithReuseIdentifier: PublicPetCollectionViewCell.identifier
        )
    }
