...
final class QuickActionButtonsCollectionView: UIView {
    ...
    lazy var quickActionCollection: UICollectionView = { collection in
        ...
        collection.register(
            QuickActionCell.self,
            forCellWithReuseIdentifier: QuickActionCell.indentifier
        )
        return collection
    }(
        UICollectionView(
            ...
            collectionViewLayout: UICollectionViewCompositionalLayout(
                section: createQuickActionSection()
            )
        )
    )
...
extension QuickActionButtonsCollectionView: UICollectionViewDataSource {
    ...
    func collectionView(
        ...
        if let cell = collectionView.dequeueReusableCell(
            withReuseIdentifier: QuickActionCell.indentifier,
            for: indexPath
        ) as? QuickActionCell {
